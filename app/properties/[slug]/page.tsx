...
export default async function DynamicPropertyPage(
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen relative pb-20 pt-[70px] md:pt-[80px] overflow-x-hidden">
        {/* ADDED SCROLLBAR HIDE CSS FIX HERE */}
        <style>{`
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-[1300px] mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3 md:gap-6">
            ...
            {/* THE FIX: Removed hidden md:flex so logo shows on mobile */}
      ...
      <div className="max-w-[1300px] mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        {/* ============================================================== */}
        {/* MOBILE ONLY: Price & CTAs directly below Gallery */}
        {/* ============================================================== */}
        <div className="lg:hidden flex flex-col gap-4 mt-6 mb-8 border-b border-gray-200 pb-8">
          ...
          <div className="flex flex-col gap-3">
            <button className="w-full py-3.5 rounded-[8px] border border-[#21409A] text-[#21409A] font-semibold text-[15px] hover:bg-[#f4f7fb] transition-all flex items-center justify-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-8 flex flex-col gap-10 md:gap-12 w-full overflow-hidden">
            ...
            <section id="overview" className="scroll-mt-[130px] md:scroll-mt-[160px] w-full">
              ...
              <div className="text-[#374151] text-[14px] md:text-[16px] leading-[1.8] w-full">
                ...
                {/* Fixed Overflow: Force break-words and strip fixed widths from database HTML */}
                <div 
            ...
            <section id="price" className="scroll-mt-[130px] md:scroll-mt-[160px] w-full">
              ...
              {/* Responsive Horizontal Scroll for Mobile Table */}
          ...
          {/* ============================================================== */}
          {/* RIGHT COLUMN (SIDEBAR) - HIDDEN ON MOBILE (hidden lg:block) */}
          {/* ============================================================== */}
              ...
              <div className="bg-white rounded-[16px] p-6 shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-gray-100 w-full">
                ...
                <form className="flex flex-col gap-5 w-full">
                  ...
                  <label className="flex items-start gap-3 mt-2 cursor-pointer w-full">
                    ...
                    <span className="text-[11px] text-gray-500 leading-snug break-words">I authorize {property.title} and its representatives to contact me with updates via SMS, Email, WhatsApp and Call about its details and offers. This consent overrides any registration for DNC / NDNC.</span>
                  </label>
      ...
      {/* ============================================================== */}
      {/* FLOATING ACTION BUTTONS (Adjusted to prevent overlapping) */}
      {/* ============================================================== */}
      ...
      <a 
        ...
        target="_blank" 
        rel="noreferrer" 
        className="fixed bottom-[75px] md:bottom-8 right-4 md:right-6 z-50 bg-[#25D366] text-white w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
